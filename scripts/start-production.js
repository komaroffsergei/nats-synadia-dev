...
const childEnv = {
  ...
  YOUTRACK_MCP_URL: process.env.YOUTRACK_MCP_URL || "",
  YOUTRACK_MCP_TIMEOUT_MS: process.env.YOUTRACK_MCP_TIMEOUT_MS || process.env.YOUTRACK_TIMEOUT_MS || "15000",
  YOUTRACK_API_CHECK_PROJECT: process.env.YOUTRACK_API_CHECK_PROJECT || "",
